...
class CandleFactory {
    constructor() {
        ...
        this.startCandle = (stockName) => new Promise(async (resolve, reject) => {
            let currentStockPrice = await sheetReader.retrieveStockPriceFromSheet(stockName).catch((error) => {
                reject(error)
            });
        ...
        this.finishCandle = (startedCandle, topPrice, bottomPrice,) => new Promise(async (resolve, reject) => {
            ...
            let currentStockPrice = await sheetReader
                .retrieveStockPriceFromSheet(startedCandle.stockName)
        ...
        this.buildFirstCandle = (stockName) => new Promise(async (resolve, reject) => {
            ...
            let interval = setInterval(async function () {
                ...
                if (!firstCandle.closingTime) {
                    ...
                    const currentTime = await timeReader.currentTime().catch((error) => {
                        reject(error)
                    });
